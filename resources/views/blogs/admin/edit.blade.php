            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">PNG, JPG, GIF (Max: 2MB) - Leave empty to keep current image</small>
                            @error('image')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <img src="{{ asset($blog->image) }}" alt="{{ $blog->title }}" class="img-fluid" style="max-height: 150px;">
                            </div>
                        </div>
                    </div>
                @endif
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                        id="meta_description" name="meta_description" rows="3" placeholder="Enter meta description">{{ old('meta_description', $blog->meta_description) }}</textarea>
